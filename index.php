                      ...
                      <div class="table-responsive">
                        ...
                        >
                          ...
                          <tbody>
                            ...
                            $sql = "SELECT *,withdrawals.id AS id,withdrawals.status AS status FROM withdrawals,users WHERE withdrawals.status=2 AND withdrawals.datetime BETWEEN '$today' AND '$tomorrow' AND users.id=withdrawals.user_id";
                            $db->sql($sql);
                            $result = $db->getResult();
                            foreach ($result as $value) {
                            ?>
                      ...
                      <div class="table-responsive">
                        ...
                        >
                          ...
                          <tbody>
                            ...
                            $sql = "SELECT *,withdrawals.id AS id,withdrawals.status AS status FROM withdrawals,users WHERE withdrawals.status=1 AND withdrawals.datetime BETWEEN '$yesterday' AND '$tomorrow' - INTERVAL 1 SECOND AND users.id=withdrawals.user_id";
                            $db->sql($sql);
                            $result = $db->getResult();
                            foreach ($result as $value) {
                            ?>
